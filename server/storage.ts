...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A Java tool that performs linear regression on household electric power consumption data from the UCI Machine Learning Repository.",
    url: null,
    githubUrl: "https://github.com/AdeyemiA/TimeSeriesAnalysis",
    category: "Tool",
    language: "Java",
    stars: null,
    isFeatured: false
  ...
  {
    id: 4,
    name: "Transformer Model Attention",
    description: "An exploration of the transformer architecture, examining self-attention mechanisms and their role in sequence modeling.",
    url: null,
    githubUrl: "https://github.com/aladesawe/transformer_model_attention",
